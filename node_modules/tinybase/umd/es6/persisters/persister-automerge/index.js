(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ...
      : ((global =
        ...
        factory((global.TinyBasePersisterAutomerge = {})));
  ...
  const createAutomergePersister = (
    ...
    const getPersisted = () =>
      __async(void 0, null, function* () {
        const doc = yield docHandle.doc();
        return objSize(doc == null ? void 0 : doc[docObjName]) == 2
          ? getDocContent(doc, docObjName)
          : void 0;
      });
    const setPersisted = (getContent, changes) =>
      __async(void 0, null, function* () {
        return docHandle.change((doc) =>
  ...
  exports.createAutomergePersister = createAutomergePersister;
});
