(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ...
      : ((global =
        ...
        factory((global.TinyBasePersisterDurableObjectStorage = {})));
  ...
  const createDurableObjectStoragePersister = (
    ...
    const getPersisted = () =>
      __async(void 0, null, function* () {
        ...
        (yield storage.list({prefix: storagePrefix})).forEach((_0, _1) =>
          __async(
            void 0,
            [_0, _1],
            function* ([zeroOrCellOrValue, time, hash], key) {
              return ifNotUndefined(deconstructKey(key), ([type, ...ids]) =>
                type == T
                  ? ifNotUndefined(
                      ids[0],
                      (tableId) => {
      ...
      __async(
        ...
        function* (
          ...
          objForEach(tablesObj, ([tableObj, tableTime, tableHash], tableId) => {
            mapSet(keysToSet, constructKey(T, tableId), [
              0,
              tableTime,
              tableHash,
            ]);
            objForEach(tableObj, ([rowObj, rowTime, rowHash], rowId) => {
              ...
              objForEach(rowObj, (cellStamp, cellId) =>
                mapSet(
                  keysToSet,
                  constructKey(T, tableId, rowId, cellId),
                  cellStamp,
                ),
              );
            });
          ...
          yield storage.put(mapToObj(keysToSet));
        },
      );
  ...
  exports.createDurableObjectStoragePersister =
