(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('yjs'))
    : typeof define === 'function' && define.amd
      ? define(['exports', 'yjs'], factory)
      : ((global =
          typeof globalThis !== 'undefined' ? globalThis : global || self),
        factory((global.TinyBasePersisterYjs = {}), global.yjs));
})(this, function (exports, yjs) {
  'use strict';
    ...
    arrayForEach(events, ({path, changes: {keys}}) =>
      arrayShift(path) == T
              ...
              ifNotUndefined(
                ...
                (yRowId) => {
                  ...
                  mapForEach(
                    ...
                    (cellId, {action}) =>
                      (row[cellId] =
                        action == DELETE ? null : yRow.get(cellId)),
                  );
                },
                () =>
                  mapForEach(
        ...
        : mapForEach(
            ...
            (valueId, {action}) =>
              (values[valueId] =
                action == DELETE ? null : yValues.get(valueId)),
          ),
    );
