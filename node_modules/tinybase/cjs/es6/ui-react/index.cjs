...
const useThing = (id, offset) => {
  ...
  return isUndefined(id)
    ...
    : isString(id)
      ? objGet((_a = contextValue[offset * 2 + 1]) != null ? _a : {}, id)
      : id;
};
const useThings = (offset) =>
  __spreadValues$1({}, useContext(Context)[offset * 2 + 1]);
...
const useThingIds = (offset) => {
  var _a;
  return objIds((_a = useContext(Context)[offset * 2 + 1]) != null ? _a : {});
};
...
const useCreate = (store, create, createDeps = EMPTY_ARRAY) => {
  ...
  useEffect(
    () => {
      ...
      setThing(newThing);
      rerender([]);
      return newThing == null ? void 0 : newThing.destroy;
    },
...
const addAndDelListener = (thing, listenable, ...args) => {
  var _a;
  const listenerId =
    (_a = thing == null ? void 0 : thing[ADD + listenable + LISTENER]) == null
      ? void 0
      : _a.call(thing, ...args);
  return () => (thing == null ? void 0 : thing.delListener(listenerId));
};
        ...
        (_b =
          (_a =
            thing == null
              ? void 0
              : thing[
                  (returnType == 4 /* Boolean */ ? _HAS : GET) + listenable
                ]) == null
            ? void 0
            : _a.call(thing, ...args)) != null
          ? _b
          : DEFAULTS[returnType];
      return !((_c = IS_EQUALS[returnType]) != null ? _c : isEqual)(
        nextResult,
        lastResult.current,
      )
...
const useCheckpointAction = (checkpointsOrCheckpointsId, action, arg) => {
  ...
  return useCallback(
    () => (checkpoints == null ? void 0 : checkpoints[action](arg)),
    // eslint-disable-next-line react-hooks/exhaustive-deps
...
const useUndoInformation = (checkpointsOrCheckpointsId) => {
  ...
  return [
    ...
    currentId,
    (_a = ifNotUndefined(currentId, (id) =>
      checkpoints == null ? void 0 : checkpoints.getCheckpoint(id),
    )) != null
      ? _a
      : EMPTY_STRING,
  ];
...
const useRedoInformation = (checkpointsOrCheckpointsId) => {
  ...
  return [
    ...
    forwardId,
    (_a = ifNotUndefined(forwardId, (id) =>
      checkpoints == null ? void 0 : checkpoints.getCheckpoint(id),
    )) != null
      ? _a
      : EMPTY_STRING,
...
const useCreatePersister = (
    ...
    () => {
      (() =>
        __async(void 0, null, function* () {
          const persister2 = store ? yield create(store) : void 0;
          setPersister(persister2);
          if (persister2 && then) {
            (() =>
              __async(void 0, null, function* () {
                yield then(persister2);
                rerender([]);
              }))();
          }
        }))();
  ...
  useEffect(
    () => () => {
      if (persister) {
        persister.destroy();
        destroy == null ? void 0 : destroy(persister);
      }
    },
    // eslint-disable-next-line react-hooks/exhaustive-deps
...
const useCreateSynchronizer = (
  ...
  useEffect(
    () => {
      (() =>
        __async(void 0, null, function* () {
          const synchronizer2 = store ? yield create(store) : void 0;
  ...
  useEffect(
    () => () => {
      if (synchronizer) {
        ...
        destroy == null ? void 0 : destroy(synchronizer);
      }
    },
    // eslint-disable-next-line react-hooks/exhaustive-deps
...
const mergeParentThings = (
  ...
  defaultThing != null ? defaultThing : parentValue[offset * 2],
  __spreadValues(
    __spreadValues(__spreadValues({}, parentValue[offset * 2 + 1]), thingsById),
  ...
  wrap(
    arrayMap(rowIds, (rowId) =>
      /* @__PURE__ */ createElement(
        Row,
        __spreadProps(
          __spreadValues({}, getProps(getRowComponentProps, rowId)),
          {
            key: rowId,
            tableId,
            rowId,
  ...
  wrap(
    arrayMap(rowIds, (rowId) =>
      /* @__PURE__ */ createElement(
        ResultRow,
        __spreadProps(
          __spreadValues({}, getProps(getResultRowComponentProps, rowId)),
          {
            key: rowId,
            queryId,
            rowId,
  ...
  return wrap(
    arrayMap(rowIds, (rowId2) =>
      /* @__PURE__ */ createElement(
        Row,
        __spreadProps(
          __spreadValues({}, getProps(getRowComponentProps, rowId2)),
          {
            key: rowId2,
...
const useCustomOrDefaultCellIds = (customCellIds, tableId, rowId, store) => {
  ...
  return customCellIds != null ? customCellIds : defaultCellIds;
};
const CellView = ({tableId, rowId, cellId, store, debugIds}) => {
  var _a;
  return wrap(
    EMPTY_STRING +
      ((_a = useCell(tableId, rowId, cellId, store)) != null
        ? _a
        : EMPTY_STRING),
    void 0,
    debugIds,
    ...
    arrayMap(
      ...
      (cellId) =>
        /* @__PURE__ */ createElement(
          Cell,
          __spreadProps(
            __spreadValues({}, getProps(getCellComponentProps, cellId)),
            {
              key: cellId,
              tableId,
              rowId,
...
const SortedTableView = (_a) => {
  var _b = _a,
    {cellId, descending, offset, limit} = _b,
    props = __objRest(_b, ['cellId', 'descending', 'offset', 'limit']);
  return tableView(
    props,
    useSortedRowIds(
      props.tableId,
  ...
  wrap(
    arrayMap(useTableIds(store), (tableId) =>
      /* @__PURE__ */ createElement(
        Table,
        __spreadProps(
          __spreadValues({}, getProps(getTableComponentProps, tableId)),
          {
            key: tableId,
            tableId,
            store,
...
const ValueView = ({valueId, store, debugIds}) => {
  ...
  return wrap(
    EMPTY_STRING +
      ((_a = useValue(valueId, store)) != null ? _a : EMPTY_STRING),
    void 0,
    debugIds,
    valueId,
  );
...
const MetricView = ({metricId, metrics, debugIds}) => {
  var _a;
  return wrap(
    (_a = useMetric(metricId, metrics)) != null ? _a : EMPTY_STRING,
    void 0,
    debugIds,
    metricId,
  );
  ...
  wrap(
    arrayMap(useSliceIds(indexId, indexes), (sliceId) =>
      /* @__PURE__ */ createElement(
        Slice,
        __spreadProps(
          __spreadValues({}, getProps(getSliceComponentProps, sliceId)),
          {
            key: sliceId,
            indexId,
            sliceId,
...
const ResultCellView = ({queryId, rowId, cellId, queries, debugIds}) => {
  ...
  return wrap(
    EMPTY_STRING +
      ((_a = useResultCell(queryId, rowId, cellId, queries)) != null
        ? _a
        : EMPTY_STRING),
    void 0,
    debugIds,
  ...
  wrap(
    arrayMap(useResultCellIds(queryId, rowId, queries), (cellId) =>
      /* @__PURE__ */ createElement(
        ResultCell,
        __spreadProps(
          __spreadValues({}, getProps(getResultCellComponentProps, cellId)),
          {
            key: cellId,
            queryId,
            rowId,
...
const ResultSortedTableView = (_c) => {
  var _d = _c,
    {cellId, descending, offset, limit} = _d,
    props = __objRest(_d, ['cellId', 'descending', 'offset', 'limit']);
...
const CheckpointView = ({checkpoints, checkpointId, debugIds}) => {
  var _a;
  return wrap(
    (_a = useCheckpoint(checkpointId, checkpoints)) != null ? _a : EMPTY_STRING,
    void 0,
    debugIds,
    checkpointId,
  );
