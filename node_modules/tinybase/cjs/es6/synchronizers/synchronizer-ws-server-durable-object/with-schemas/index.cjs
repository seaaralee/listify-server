...
var _serverClientSend,
  _WsServerDurableObject_instances,
  handleMessage_fn,
  getClients_fn;
const PATH_REGEX = /\/([^?]*)/;
...
const getPathId = (request) => {
  var _a, _b;
  return (_b =
    (_a = strMatch(new URL(request.url).pathname, PATH_REGEX)) == null
      ? void 0
      : _a[1]) != null
    ? _b
    : EMPTY_STRING;
...
const getClientId = (request) => {
  var _a;
  return ((_a = request.headers.get('upgrade')) == null
    ? void 0
...
class WsServerDurableObject extends cloudflare_workers.DurableObject {
  constructor(ctx, env) {
    super(ctx, env);
    __privateAdd(this, _WsServerDurableObject_instances);
    // @ts-expect-error See blockConcurrencyWhile
    __privateAdd(this, _serverClientSend);
    this.ctx.blockConcurrencyWhile(() =>
      __async(this, null, function* () {
        return yield ifNotUndefined(yield this.createPersister(), (persister) =>
          __async(this, null, function* () {
            const synchronizer = createCustomSynchronizer(
              ...
              (receive) =>
                __privateSet(this, _serverClientSend, (payload) =>
  ...
  webSocketMessage(client, message) {
    ifNotUndefined(this.ctx.getTags(client)[0], (clientId) =>
      __privateMethod(
        ...
        _WsServerDurableObject_instances,
        handleMessage_fn,
      ).call(this, clientId, message.toString(), client),
    );
  }
...
_serverClientSend = new WeakMap();
_WsServerDurableObject_instances = new WeakSet();
// --
handleMessage_fn = function (fromClientId, message, fromClient) {
  ifPayloadValid(message.toString(), (toClientId, remainder) => {
    ...
    if (toClientId == EMPTY_STRING) {
      if (fromClientId != SERVER_CLIENT_ID) {
        (_a = __privateGet(this, _serverClientSend)) == null
          ? void 0
          : _a.call(this, forwardedPayload);
      }
      arrayForEach(
        __privateMethod(
          this,
      ...
      (_b = __privateGet(this, _serverClientSend)) == null
        ? void 0
        : _b.call(this, forwardedPayload);
    } else if (toClientId != fromClientId) {
      (_c = __privateMethod(
        this,
        _WsServerDurableObject_instances,
        getClients_fn,
      ).call(this, toClientId)[0]) == null
        ? void 0
        : _c.send(forwardedPayload);
    }
  });
};
getClients_fn = function (tag) {
